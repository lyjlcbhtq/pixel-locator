...
# name, script+args, 期望输出中出现的关键字（None = 只看退出码）
CASES = [
    ...
    ("vlocate 候选清单（零模型，供上层 AI 挑）",
     ["vlocate.py", "--image", SAMPLE, "--list-all"], '"mode": "candidates"'),
    ("findtext 找字（像素级坐标）",
     ["findtext.py", "--image", SAMPLE, "--query", "像素级定位"], "像素级定位"),
    ("findtext 全文识别",
     ["findtext.py", "--image", SAMPLE, "--all"], "工具包"),
    ("tmatch 模板匹配",
     ["tmatch.py", "find", TEMPLATE, SAMPLE], '"found": true'),
